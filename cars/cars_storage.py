...
class CarMongoStorage:
    ...
    def update_car(self, car, car_id):
        self.db.update_one({'_id': ObjectId(car_id)}, {'$set': {'name': car.name, 'brand': car.brand, 'color': car.color,
                           'model_year': car.model_year, 'price': car.price, 'store_id': car.store_id, 'km': car.km, 'city': car.city, 'rent': car.rent}})
        return car_id
